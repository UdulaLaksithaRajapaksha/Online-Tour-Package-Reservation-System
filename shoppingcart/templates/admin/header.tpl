	...
	<?php if ($authentication->logged_in() && $authentication->is_admin()): ?>
		...
		<div id="header" class="container_12">
			...
			<div id="main_menu" class="grid_9">
				<ul>
                <li><a href="index.php" <?php if (in_array(basename($_SERVER['PHP_SELF']), array('index.php'))) echo 'class="current"'; ?>>Dashboard</a></li>
					...
					<li><a href="products.php" <?php if (in_array(basename($_SERVER['PHP_SELF']), array('products.php', 'add_product.php', 'edit_product.php'))) echo 'class="current"'; ?>>Package</a></li>
