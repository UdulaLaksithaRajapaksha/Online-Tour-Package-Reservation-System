		...
		<div class="grid_12">
         ...
         <h1>Create New Account</h1>
            ...
            <div class="title_background">
				...
				<p>
					<label>Select Type: <span title="Required field">*</span></label>
				...
				<p>
					<label>Nationality: <span title="Required field">*</span></label>
					<input type="text" id="nationality" name="nationality" size="50" value="<?php if (isset($_POST['nationality'])) echo $_POST['nationality']; ?>" />
				</p>
